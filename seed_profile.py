...
def seed():
    with app.app_context():
        ...
        search_configs = [
            ...
            # --- Fortune 500 / Major Company Direct Searches ---
            # These skip Indeed (requires account) and search LinkedIn, Glassdoor,
            # ZipRecruiter, and Google Jobs directly.
            #
            # FAANG / Big Tech
            {
                "name": "Apple - Video/Creative Roles",
                "search_terms": "video producer Apple, creative director Apple, video editor Apple, content producer Apple",
                "boards": "linkedin,glassdoor,zip_recruiter,google",
                "location": "",
                "remote_only": False,
                "results_wanted": 25,
                "interval_hours": 12,
            ...
            {
                "name": "Google - Video/Creative Roles",
                "search_terms": "video producer Google, creative director Google, video editor Google, content producer Google",
                "boards": "linkedin,glassdoor,zip_recruiter,google",
                "location": "",
                "remote_only": False,
                "results_wanted": 25,
            ...
            {
                "name": "Meta - Video/Creative Roles",
                "search_terms": "video producer Meta, creative director Meta, video editor Meta, content producer Meta",
                "boards": "linkedin,glassdoor,zip_recruiter,google",
                "location": "",
                "remote_only": False,
                "results_wanted": 25,
            ...
            {
                "name": "Amazon - Video/Creative Roles",
                "search_terms": "video producer Amazon, creative director Amazon, video editor Amazon, content producer Amazon",
                "boards": "linkedin,glassdoor,zip_recruiter,google",
                "location": "",
                "remote_only": False,
                "results_wanted": 25,
            ...
            {
                "name": "Netflix - Video/Creative Roles",
                "search_terms": "video producer Netflix, creative director Netflix, post production Netflix, content Netflix",
                "boards": "linkedin,glassdoor,zip_recruiter,google",
                "location": "",
                "remote_only": False,
                "results_wanted": 25,
            ...
            # AI Companies
            {
                "name": "Anthropic - All Creative Roles",
                "search_terms": "video Anthropic, creative Anthropic, producer Anthropic, content Anthropic, director Anthropic",
                "boards": "linkedin,glassdoor,zip_recruiter,google",
                "location": "",
                "remote_only": False,
                "results_wanted": 25,
            ...
            {
                "name": "OpenAI - All Creative Roles",
                "search_terms": "video OpenAI, creative OpenAI, producer OpenAI, content OpenAI, director OpenAI",
                "boards": "linkedin,glassdoor,zip_recruiter,google",
                "location": "",
                "remote_only": False,
                "results_wanted": 25,
            ...
            {
                "name": "Microsoft - Video/Creative Roles",
                "search_terms": "video producer Microsoft, creative director Microsoft, video editor Microsoft, content producer Microsoft",
                "boards": "linkedin,glassdoor,zip_recruiter,google",
                "location": "",
                "remote_only": False,
                "results_wanted": 25,
            ...
            {
                "name": "Salesforce - Video/Creative Roles",
                "search_terms": "video producer Salesforce, creative director Salesforce, content producer Salesforce",
                "boards": "linkedin,glassdoor,zip_recruiter,google",
                "location": "",
                "remote_only": False,
                "results_wanted": 25,
            ...
            {
                "name": "Adobe - Video/Creative Roles",
                "search_terms": "video producer Adobe, creative director Adobe, video editor Adobe, content producer Adobe",
                "boards": "linkedin,glassdoor,zip_recruiter,google",
                "location": "",
                "remote_only": False,
                "results_wanted": 25,
            ...
            # AI / ML Startups & Growth Companies
            {
                "name": "AI Startups - Video/Creative",
                "search_terms": "video producer Midjourney, creative director Runway, video producer Stability AI, video Hugging Face, creative Cohere",
                "boards": "linkedin,glassdoor,zip_recruiter,google",
                "location": "",
                "remote_only": False,
                "results_wanted": 25,
            ...
            {
                "name": "AI Growth - Video/Creative",
                "search_terms": "video producer Databricks, creative director Scale AI, video producer Perplexity, creative Character AI, video Inflection",
                "boards": "linkedin,glassdoor,zip_recruiter,google",
                "location": "",
                "remote_only": False,
                "results_wanted": 25,
            ...
            {
                "name": "Nvidia - Video/Creative Roles",
                "search_terms": "video producer Nvidia, creative director Nvidia, video editor Nvidia, content producer Nvidia",
                "boards": "linkedin,glassdoor,zip_recruiter,google",
                "location": "",
                "remote_only": False,
                "results_wanted": 25,
            ...
            # Media & Entertainment
            {
                "name": "Disney - Video/Creative Roles",
                "search_terms": "video producer Disney, creative director Disney, post production Disney, content producer Disney",
                "boards": "linkedin,glassdoor,zip_recruiter,google",
                "location": "",
                "remote_only": False,
                "results_wanted": 25,
            ...
            {
                "name": "Warner Bros / Paramount - Creative",
                "search_terms": "video producer Warner Bros, creative director Paramount, video producer Sony Pictures, producer NBC Universal",
                "boards": "linkedin,glassdoor,zip_recruiter,google",
                "location": "",
                "remote_only": False,
                "results_wanted": 25,
            ...
            {
                "name": "Spotify / Streaming - Creative",
                "search_terms": "video producer Spotify, creative director Spotify, video producer Hulu, creative director YouTube",
                "boards": "linkedin,glassdoor,zip_recruiter,google",
                "location": "",
                "remote_only": False,
                "results_wanted": 25,
            ...
            # Tech / SaaS / Platform
            {
                "name": "Uber / Airbnb / Lyft - Creative",
                "search_terms": "video producer Uber, creative director Airbnb, video producer Lyft, content producer DoorDash",
                "boards": "linkedin,glassdoor,zip_recruiter,google",
                "location": "",
                "remote_only": False,
                "results_wanted": 25,
            ...
            {
                "name": "LinkedIn / Twitter / Snap - Creative",
                "search_terms": "video producer LinkedIn, creative director X, video producer Snap, content producer Pinterest, video Reddit",
                "boards": "linkedin,glassdoor,zip_recruiter,google",
                "location": "",
                "remote_only": False,
                "results_wanted": 25,
            ...
            {
                "name": "Stripe / Square / Fintech - Creative",
                "search_terms": "video producer Stripe, creative director Square, video producer PayPal, creative Robinhood, video Coinbase",
                "boards": "linkedin,glassdoor,zip_recruiter,google",
                "location": "",
                "remote_only": False,
                "results_wanted": 25,
            ...
            {
                "name": "Oracle / SAP / IBM - Creative",
                "search_terms": "video producer Oracle, creative director SAP, video producer IBM, content producer Cisco, video VMware",
                "boards": "linkedin,glassdoor,zip_recruiter,google",
                "location": "",
                "remote_only": False,
                "results_wanted": 25,
            ...
            {
                "name": "Shopify / HubSpot / SaaS - Creative",
                "search_terms": "video producer Shopify, creative director HubSpot, video producer Atlassian, creative Twilio, video Zoom",
                "boards": "linkedin,glassdoor,zip_recruiter,google",
                "location": "",
                "remote_only": False,
                "results_wanted": 25,
            ...
            # Finance & Consulting
            {
                "name": "Goldman / JPMorgan / Banks - Creative",
                "search_terms": "video producer Goldman Sachs, creative director JPMorgan, video producer Morgan Stanley, video Bank of America",
                "boards": "linkedin,glassdoor,zip_recruiter,google",
                "location": "",
                "remote_only": False,
                "results_wanted": 25,
            ...
            {
                "name": "McKinsey / Deloitte / Consulting - Creative",
                "search_terms": "video producer McKinsey, creative director Deloitte, video producer Accenture, creative PwC, video EY",
                "boards": "linkedin,glassdoor,zip_recruiter,google",
                "location": "",
                "remote_only": False,
                "results_wanted": 25,
            ...
            # Consumer / Retail / CPG
            {
                "name": "Nike / Consumer Brands - Creative",
                "search_terms": "video producer Nike, creative director Coca-Cola, video producer Procter Gamble, creative Pepsi, video Johnson Johnson",
                "boards": "linkedin,glassdoor,zip_recruiter,google",
                "location": "",
                "remote_only": False,
                "results_wanted": 25,
            ...
            # Tesla / Automotive
            {
                "name": "Tesla / EV / Auto - Creative",
                "search_terms": "video producer Tesla, creative director Rivian, video producer Lucid, creative director BMW, video Porsche",
                "boards": "linkedin,glassdoor,zip_recruiter,google",
                "location": "",
                "remote_only": False,
                "results_wanted": 25,
